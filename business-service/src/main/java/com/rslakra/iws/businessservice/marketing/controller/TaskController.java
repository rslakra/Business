...
import com.rslakra.iws.businessservice.marketing.filter.TaskFilter;
import com.rslakra.iws.businessservice.marketing.parser.TaskParser;
import com.rslakra.iws.businessservice.marketing.persistence.entity.Task;
import com.rslakra.iws.businessservice.marketing.service.TaskService;
...
public class TaskController extends AbstractRestController<Task, Long> {
    ...
    public ResponseEntity<Payload> delete(@PathVariable(value = "taskId") Optional<Long> idOptional) {
        ...
        Payload<String, Object>
            payload =
            Payload.newBuilder().withDeleted(Boolean.TRUE)
